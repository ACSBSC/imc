        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              imcModelo.esNormal ?Text("Tu IMC es Normal", style: TextStyle(color: Colors.red[700], fontSize: 34, fontWeight: FontWeight.w700),)
                  :Text("Tu IMC no es normal", style: TextStyle(color: Colors.red[700], fontSize: 34, fontWeight: FontWeight.w700),)
              ,
              SizedBox(height: 16,),
